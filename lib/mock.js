...
function analyseProfile(digest, images) {
  ...
  const data = {
    ...
    mbti: {
      ...
      atYourBest: 'Mock description of this type running well.',
      underStress: 'Mock description of how this type comes apart.',
      misreadAs: 'Mock description of how people misread this type.',
      growthEdges: [point('Ask for things directly'), point('Let a plan stay open')],
      keyTakeaways: [
        'Mock takeaway one, specific to this person.',
        'Mock takeaway two.',
        'Mock takeaway three.',
      ],
