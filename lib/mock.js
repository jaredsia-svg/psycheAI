...
// the roast (harsh/advice, moved here from the old free-report bonus field)
// plus two evidence-bearing lists, no caveat field — so the mock flow
// exercises the same rendering path a real call does. The safety caveat
// itself is static copy shown by the client regardless of what this returns,
// not part of this schema at all. Never a condition name here either: the
// mock content is what a fixture-writer would put in the field, and this
