...
function analyseProfile(digest, images) {
  ...
  const data = {
    ...
    summary: 'Mock summary paragraph one, landing the ENFJ type and the standout traits.\n\n' +
      'Mock summary paragraph two, covering the relational and career read.',
    bigFive: {
    ...
    activity: {
      ...
      diet: {
        ...
        topAccounts: [
          { account: '@mockoutlet', kind: 'media', share: 'about 1 like in 9', why: 'Mock read of what this account being here says.' },
          { account: 'a friend you post with', kind: 'personal', share: '31 comments, more than any other account', why: 'Mock read of a personal account, named by description rather than handle.' },
          { account: '@mockbrand', kind: 'brand', share: '48 saves, second only to the outlet above', why: 'Mock read of a brand account.' },
        ],
        algorithmRead: 'Mock comparison between Instagram\'s inferred topics and what this person actually posts.',
      },
      blindSpots: 'Mock note on what this behavioural read cannot see.',
      recommendations: [
        { title: 'Mock change worth making', detail: 'Mock detail tracing back to something in the section above.' },
      ],
      antiRecommendations: [
        { title: 'Mock thing not to change', detail: 'Mock detail naming the usual advice it contradicts.' },
      ],
    },
    ...
    bonus: {
      ...
      advice: 'Mock unsoftened advice, first paragraph.\n\nMock unsoftened advice, second paragraph, drawn from the report rather than the posting habits.',
      trajectory: 'Mock behavioural forecast, first paragraph.\n\nMock behavioural forecast, second paragraph, naming what would change it and no condition of any kind.',
    },
    card: {
