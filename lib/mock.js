...
function analyseProfile(digest, images) {
  ...
  const data = {
    ...
    essence: {
      noun: 'The Riverbed',
      icon: '🏞️',
      why: 'Mock reasoning for why this noun and not a neighbouring one.',
    },
    ...
    mbti: {
      ...
      portrait: 'Mock portrait — one paragraph in a real run, covering where the type serves them, where it costs them, and how they get misread.',
