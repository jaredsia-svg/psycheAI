...
function analyseProfile(digest) {
  ...
  const data = {
    ...
    mbti: {
      ...
      // Every axis carries its opposing case, because the strength beside the
      // letter is read off the gap between the two. The `clear` one is the
      // exception the schema allows — an empty counter — so that both branches
      // of the rendering are exercised by a single mock run.
      letters: [
        { axis: 'E/I', choice: 'E', strength: 'moderate', why: 'Mock reasoning.', counterEvidence: 'Mock opposing evidence, stated at full strength, and why it did not carry the axis.', inPractice: 'Mock practice note.' },
        { axis: 'N/S', choice: 'N', strength: 'slight', why: 'Mock reasoning.', counterEvidence: 'Mock opposing evidence, close enough to make this axis slight.', inPractice: 'Mock practice note.' },
        { axis: 'T/F', choice: 'F', strength: 'clear', why: 'Mock reasoning.', counterEvidence: '', inPractice: 'Mock practice note.' },
        { axis: 'J/P', choice: 'J', strength: 'moderate', why: 'Mock reasoning.', counterEvidence: 'Mock opposing evidence on rhythm, and why the steadier reading won.', inPractice: 'Mock practice note.' },
      ],
