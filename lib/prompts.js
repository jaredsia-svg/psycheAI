...
const PROFILE_SCHEMA = object({
  ...
  relationship: object({
    ...
    loveLanguages: object({
      ...
      mismatch: { type: 'string', description: 'Two or three sentences on the gap between how they give and how they want to receive, what that costs them, and what to do about it. If the two line up, say so and say why that is easier.' },
