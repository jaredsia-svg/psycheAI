...
const PROFILE_SCHEMA = object({
  ...
  mbti: object({
    ...
    portrait: { type: 'string', description: 'Two or three paragraphs separated by blank lines, written to them as "you", on what being this type actually feels like from the inside. Specific to them, not a copied type description.' },
    atYourBest: { type: 'string', description: 'Two or three sentences: this type running well, as it shows up in their data.' },
    underStress: { type: 'string', description: 'Two or three sentences: how this type tends to come apart, and what that would look like for them.' },
    misreadAs: { type: 'string', description: 'Two or three sentences on how people commonly misread this type, and what they are actually doing instead.' },
    growthEdges: { ...pointList, description: 'Two or three things this type habitually avoids or under-develops, and what to do about it.' },
    keyTakeaways: { ...strList, description: 'Three to five single-sentence takeaways someone could remember a week later. Each must be about this person, not the type in general.' },
...
- **MBTI**: this section should be the one they send to a friend, so make it earn that. Give your best type and its usual nickname; for each axis, say how strongly the data leans and what that letter looks like in *their* week rather than in a textbook. The **portrait** is the heart of it — what being this type feels like from the inside, written to them, grounded in things you can actually point to in their data. Then how the type runs at its best, how it comes apart under stress, and how people misread them. **growthEdges** should sting slightly and be actionable. **keyTakeaways** must each be about this person: if a sentence would be true of every INFP alive, rewrite it or cut it. Where an axis is genuinely close, say "slight" and mean it — a hedged letter is more useful than a confident wrong one.
