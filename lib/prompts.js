...
const PROFILE_SCHEMA = object({
  ...
  summary: { type: 'string', description: 'Three to five paragraphs, separated by blank lines. Write to them, as "you". Do not re-explain the noun above — carry on from it.' },
  bigFive: object({
  ...
  mbti: object({
    ...
    portrait: { type: 'string', description: 'Three or four paragraphs separated by blank lines, written to them as "you", on what being this type actually feels like from the inside — including where it serves them, where it costs them, and how they are commonly misread. Specific to them, not a copied type description.' },
