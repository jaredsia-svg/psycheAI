...
- **Group versus one-to-one** — \`activeGroupThreads\` against \`activeThreads\`, and again not the raw \`groupThreads\`, which counts groups they were added to and sat silent in. Sustained group-chat *participation* is genuine extraversion evidence in a way dyadic messaging is not. Being in fifty group chats and speaking in one is the opposite of what it looks like.
