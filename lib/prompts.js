...
- **Big Five**: score 0-100 where 50 is an average person. Cite real evidence per trait. Note that "neuroticism" is emotional sensitivity — frame it neutrally, not as a defect. For **extraversion** specifically, apply the correction set out above: cite a breadth number in the evidence — distinct people, group threads, contact outside the usual circle — or score at or below the middle. "You send a lot of messages" is not evidence for this trait and must not be offered as any.
